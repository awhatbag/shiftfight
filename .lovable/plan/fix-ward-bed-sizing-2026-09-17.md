...
- Expand the containing bed/patient interaction area around that sprite so the container no longer scales the artwork down. Change the shape of the area if needed so that the nurse still has room to navigate around the ward, but do not scale the bed artwork down.
