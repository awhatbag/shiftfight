...
4. add a "turn on/turn off auto save toggle button in the menu.
  - the auto save toggle should be in the "on" state unless the user changes it manually.
...
- Test on a mobile-sized viewport:
  ...
  5. confirm the auto save toggle functions as intended.