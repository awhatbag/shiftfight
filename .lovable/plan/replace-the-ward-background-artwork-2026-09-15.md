...
- Check the active shift at the current mobile size and a narrower phone size. Ensure it scales in proportion to any phone size that is used to access the game.
