...
- Add a lightweight ward overlay that emits supplied avocado sprites east-to-west, with random artwork, moderate size variation, speed, lanes, rotation, bounce, and occasional diagonal travel. Use the known bed positions as simple collision zones; impacts stop for about five seconds, flicker, then disappear.
